...
# The fleet's effort levels are low, medium, high, xhigh and max. V4.1 names
# all but medium (low=25, high=50, xhigh=75, max=100) and takes integer
# budgets, so medium sits between low and high; Codex also sends minimal.
_REASONING_EFFORT_ALIASES = {"minimal": "low", "medium": 37}
